...
write.csv(Final, "/Users/aysuerdemir/Desktop/R workspace/ERP_Zoo/CrossSectional/Mix/ZOO.csv")
...
summary_plot <- create_summary_plot(data = ZOO, measurevar = "Mean.Amplitude.P2")
print(summary_plot)
